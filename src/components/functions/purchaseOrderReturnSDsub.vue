  ...
  <div class="container" v-cloak>
    ...
    <div class="content">
      <div class="mui-input-group">
        ...
        <div class="mui-input-row inforLabel">
          <label>零件描述1</label>
          <label class="showlabel disabledTrue">{{desc1}}</label>
        </div>
        <div class="mui-input-row inforLabel">
          <label>零件描述2</label>
          <label class="showlabel disabledTrue">{{desc2}}</label>
        </div>
      </div>
      <div align="center" style="margin:0 auto;width:98%;overflow:scroll;" class="detail">
        ...
        <table border class="qgg-table" style="border: 1px solid #D5D9ED;">
          <thead>
            <tr>
              <th style="color:#3B58D4;font-size: 11px;">唯一码</th>
...
export default {
  ...
  data() {
    return {
      ...
      desc1: this.$route.query.title_desc1,
      desc2: this.$route.query.title_desc2,
